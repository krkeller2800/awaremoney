...
SOURCE="$SCRIPT_DIR/CompareStrategyLandscapePlan.md"
MARKDOWN_OUTPUT="$SCRIPT_DIR/CompareStrategyLandscapePlan-embedded.md"
HTML_OUTPUT="$SCRIPT_DIR/CompareStrategyLandscapePlan-embedded.html"
...
TMP_MARKDOWN=$(mktemp "${TMPDIR:-/tmp}/compare-strategy-plan-md.XXXXXX")
TMP_HTML=$(mktemp "${TMPDIR:-/tmp}/compare-strategy-plan-html.XXXXXX")
...
html_lines = [
    ...
    "<title>Compare Strategies Portrait Plan</title>",
    "<style>",
